...
/**
 * This interface helps build the model of the animation.
 *
 * @param <Doc> model of this project that stores information of animations.
 */
public interface AnimationBuilder<Doc> {
  ...
  // Judge if the name already exists (Set/Hashmap);
  // String type -> Shape, then call doc.createShape(name, shape);
